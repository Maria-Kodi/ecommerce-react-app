...
export default function CartItems({ item, cart, setCart }) {
  return (
    <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 bg-white rounded-2xl shadow-sm p-4 mb-3">
      ...
      <p className="font-bold text-gray-800 md:w-20 text-center md:text-right">
